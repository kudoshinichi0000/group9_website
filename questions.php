                ...
                <table class='cons' width='100%' height='1em;' style='background-color: #e55f5f;'>
                  <tr>
                    <th colspan='5'>
                      ...
                      <a href='IdenDeleteHandler.php?id=$questionId'><img src='res/logo/Delete.png' width='2%' style='border-radius: 25em;' alt='image not found' data-toggle='modal' data-target='#DeleteModalIden' class='Prof' ></a>
