                  ...
                  while($admin = mysqli_fetch_assoc($result))
                  {
                    echo "
                      <tr>
                        ...
                        <a href='editadmin.php?id={$admun['userid']}' type='button' class='btn btn info badge-pill text-centered float right' style='width:80px; text-align: center;  margin:5px;'>EDIT</a>
                        </td>
                        </tr>
