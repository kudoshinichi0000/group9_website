                ...
                <tbody>
                  <?php
                    ...
                    echo "
                          ...
                          <td>
                            <a href='editadmin.php?id={$fetchid}' type='button' class='btn btn-info badge-pill text-right'>EDIT</a>
                            <a href='DeleteAdmin.php?id={$fetchid}' type='button' class='btn btn-danger badge-pill text-right'>DELETE</a>
                          </td>
                          </tr>
                    "
                  ?>
