...
<body>
	...
	<?php include_once "db.php"; include_once "navbar2.php" ?><br>
	<?php if(isset($_SESSION['errormessage'])): ?>
		...
		<!-- Admin Added -->
		<?php include_once "db.php"; include_once "navbar2.php" ?><br><br>
	...
	<div class="container">
		...
		<div class="login-content">
			<form method="POST">
            	...
            	<h4>Don't have any account?<a href="#">Sign In</a></h4>
            </form>
        </div>
    </div>
