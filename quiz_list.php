                ...
                if(strlen($title) >= 1){
                      ...
                      echo "
                        <tr>
                          ...
                          <td scope='row'>
                            <button a href='deleteQuiz.php?quiz=$code'type='button' data-toggle='modal' data-target='#DeleteModal' class='btn btn-danger badge-pill text-right float-right' style='text-align:center; margin:5px;'>Delete</button>
                            <a href='deleteQuiz.php?quiz=$code'type='button' data-toggle='modal' data-target='#DeleteModal' class='btn btn-danger badge-pill text-right float-right' style='text-align:center; margin:5px;'>Delete</a>
